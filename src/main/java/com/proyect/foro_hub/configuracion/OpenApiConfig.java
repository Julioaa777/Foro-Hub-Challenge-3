package com.proyect.foro_hub.configuracion;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI(){
        ...
        contact.setEmail("soporte@proyect.com");
        contact.setName("Proyect");
        contact.setUrl("https://proyect.com/contacto");
        ...
        Info info = new Info()
                ...
                .termsOfService("https://proyects.com/terminos-de-servicio")
                .license(mitLicense);
